...
- **OOH vintage:** Growth rates are BLS Employment Projections / OOH **2024–2034** (`DATA_SOURCES.BLS_OOH`, `scripts/extract_bls_data.py`). Employment headcounts on the map are still OES May 2023 until a workbook refresh.
