            ...
            <div className="space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-300 leading-relaxed">
                        Nothing on screen is invented or hand-estimated. Each value is either
                        real US government data, real O*NET task data, or generated by Claude
                        analyzing those real sources.
                    </p>
                    ...
                    <p className="text-[11px] text-gray-500 leading-relaxed mt-2 italic">
                        Before Claude finishes scoring a role, its AI/human labels show "—" rather
                        than a guessed value. The 3D peaks show the real BLS 10-year projection
                        until Claude produces a year-by-year forecast for that role.
                    </p>
                </div>
